				...
				>
					<Link href='/components'>
						<div className='w-full '>
							<h1 className=' m-0 w-full  grow cursor-pointer text-[7rem] font-[500] text-stone-100 transition-all  hover:text-stone-200 dark:text-stone-200 dark:hover:text-stone-100  md:text-[8rem] lg:text-[10rem]'>
